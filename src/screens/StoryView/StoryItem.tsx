...
import {StoryController} from './StoryView';
...
const StoryItem = ({
  ...
  }, [childIndex, item.storyList.length, index, maxIndex]);
  ...
  function timestampToString(arg0: any): React.ReactNode {
