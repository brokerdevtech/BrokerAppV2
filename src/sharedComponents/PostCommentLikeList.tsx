...
import { getPostCommentLikeList, getPostLikeList } from '../../BrokerAppCore/services/new/postServices';
...
const PostCommentLikeList: React.FC = ({
  isPageSkeleton,
  toggleSkeletonoff,
  toggleSkeletonOn,
  setLoading,
  ...
  const {
    ...
    currentPage_Set,
    hasMore_Set
  } = useApiPagingWithtotalRequest(getPostCommentLikeList,setInfiniteLoading);
...
export default AppBaseContainer(PostCommentLikeList, '', true);
