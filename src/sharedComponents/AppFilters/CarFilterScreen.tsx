...
const CarFilterScreen : React.FC = ({
  ...
  const {data:Filters ,status:Filtersstatus, error:Filterserror, execute:Filterexecute} = useApiRequest(getCarPostFilters);
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    ...
    const updateFilters = async () => {
      if (Filters != null) {
        try {
          console.log("updateFiltersupdateFiltersupdateFiltersupdateFiltersupdateFilters==============================")
          console.log(Filters)
...
console.log(JSON.stringify(updatedSelectedFilters));
  ...
  if (selectedItem.dependsOn) {
    ...
    {  const updatedFilters = await updateRecordsByName(filtersState, selectedItem.dependsOn, result.data.data.filters[0].records);
      setfiltersState(updatedFilters);
