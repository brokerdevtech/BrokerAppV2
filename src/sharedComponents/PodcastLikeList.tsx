...
import { getPodcastLikeList, getPostLikeList } from '../../BrokerAppCore/services/new/postServices';
...
const PodcastLikeList: React.FC = ({
  isPageSkeleton,
  toggleSkeletonoff,
  toggleSkeletonOn,
  setLoading,
  ...
  const {
    ...
    currentPage_Set,
    hasMore_Set
  } = useApiPagingWithtotalRequest(getPodcastLikeList,setInfiniteLoading);
...
export default AppBaseContainer(PodcastLikeList, '', true);
